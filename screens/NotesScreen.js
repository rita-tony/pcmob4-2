...
export default function NotesScreen({ navigation, route }) {
  ...
  function deleteNote(sId) {
    ...
    db.doc(sId).delete(); // this is doc(id) is refer to the document id generated by firebase
  }

  //This function will be called when checkbox button is clicked
  function updateIsDone(sId, bDone) {
    console.log("UpdateIsDone " + sId);
    db.doc(sId).update({ done: !bDone });
  }
